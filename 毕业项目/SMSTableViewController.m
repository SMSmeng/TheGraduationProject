...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *xinpin = @"xinpin";
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:xinpin forIndexPath:indexPath];
    if (!cell) {
        cell = [[UITableViewCell alloc]initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:xinpin];
    }
    cell.textLabel.text = @"qwertyub";
    return cell;
}
